import { Probot, Context, ApplicationFunction, ApplicationFunctionOptions } from "probot";
import { reviewPullRequest } from "../lib/helpers/review-pull-request";
import { Configuration } from "../lib/types/config";
import { redisClient } from "../lib/helpers/redis";
import { defaultConfig } from "../lib/data/default-config";
...
export const probotApp: ApplicationFunction = async (app: Probot, options?: ApplicationFunctionOptions) => {
